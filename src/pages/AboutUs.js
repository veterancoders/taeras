      ...
      <section style={{ background:'#fff', padding:'0 5% 80px', maxWidth:900, margin:'0 auto' }}>
        <Reveal>
          <div style={{ background:'#f0fafa', border:'1px solid rgba(0,180,180,0.2)', borderLeft:`4px solid ${C.teal}`, borderRadius:'0 20px 20px 0', padding:'40px 44px', marginBottom:40 }}>
            <p style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'clamp(17px,2.5vw,24px)', lineHeight:1.8, color:C.textDark, fontStyle:'italic' }}>"In 2022, I flew Lagos to Istanbul to Vienna and back — three trips, four airlines, six hotel nights. I earned 48,000 miles. Then the airline devalued them. I also paid 4.2% in FX fees I didn't notice. I came home with nothing to show for $6,000 in travel spend. That's when we started building Taeras."</p>
            <div style={{ marginTop:18, color:C.teal, fontSize:14, fontWeight:600 }}>— Adewale Okafor, Co-Founder & CEO</div>
          </div>
        </Reveal>
